...
class CallEvent(StrEnum):
    ...
    CACHED_REPLY_READY = "CACHED_REPLY_READY"
...
_EVENT_TRANSITIONS: dict[tuple[CallState, CallEvent], CallState] = {
    ...
    (CallState.LISTENING, CallEvent.USER_SPEECH_CAPTURED): CallState.INTENT_MATCHING,
    (CallState.INTENT_MATCHING, CallEvent.CACHE_MISS): CallState.THINKING,
    (CallState.INTENT_MATCHING, CallEvent.CACHED_REPLY_READY): CallState.SPEAKING,
